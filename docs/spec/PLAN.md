...
6. Add the reviewed common AI implementation-pattern catalog: contracts, fixed fixture, simple deterministic matching and deployment posture assessment. Keep it separate from six-dimension scoring, hard gates and final proposal generation.
